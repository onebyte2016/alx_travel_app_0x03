...
# ALX Travel App - Celery with RabbitMQ
...
# Chapa Payments Integration (Django)

This app integrates **Chapa** to initialize and verify payments for bookings.

## 1) Duplicate Project
Duplicate `alx_travel_app_0x01` → `alx_travel_app_0x02`. Ensure you can run the project before integrating.
